                ...
                <Row className="my-5">
                    <Col md={4} className="mb-4">
                        <Card className="h-100 p-0">
                            ...
                            <Card.Footer className="text-center">
                                <Button className="btn banadir" onClick={() => handleAddToCart(1, 'Pendiente 1')}>
                    ...
                    <Col md={4} className="mb-4">
                        <Card className="h-100 p-0">
                            ...
                            <Card.Footer className="text-center">
                                <Button className="btn banadir" onClick={() => handleAddToCart(2, 'Pendiente 2')}>
                                    Añadir a la cesta <FontAwesomeIcon icon={faShoppingCart} />
                                </Button>
                            </Card.Footer>
                        </Card>
                    ...
                    <Col md={4} className="mb-4">
                        <Card className="h-100 p-0">
                            ...
                            <Card.Footer className="text-center">
                                <Button className="btn banadir" onClick={() => handleAddToCart(3, 'Pendiente 3')}>
                                    Añadir a la cesta <FontAwesomeIcon icon={faShoppingCart} />
                                </Button>
                            </Card.Footer>
                        </Card>
                ...
                <Row className="my-5">
                    <Col md={4} className="mb-4">
                        <Card className="h-100 p-0">
                            ...
                            <Card.Footer className="text-center">
                                <Button className="btn banadir" onClick={() => handleAddToCart(4, 'Pendiente 4')}>
                                    Añadir a la cesta <FontAwesomeIcon icon={faShoppingCart} />
                                </Button>
                            </Card.Footer>
                        </Card>
                    ...
                    <Col md={4} className="mb-4">
                        <Card className="h-100 p-0">
                            ...
                            <Card.Footer className="text-center">
                                <Button className="btn banadir" onClick={() => handleAddToCart(5, 'Pendiente 5')}>
                                    Añadir a la cesta <FontAwesomeIcon icon={faShoppingCart} />
                                </Button>
                            </Card.Footer>
                        </Card>
                    ...
                    <Col md={4} className="mb-4">
                        <Card className="h-100 p-0">
                            ...
                            <Card.Footer className="text-center">
                                <Button className="btn banadir" onClick={() => handleAddToCart(6, 'Pendiente 6')}>
                                    Añadir a la cesta <FontAwesomeIcon icon={faShoppingCart} />
                                </Button>
                            </Card.Footer>
                        </Card>
